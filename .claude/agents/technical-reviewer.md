...
2. `examples/`（代码正确性、注释准确性、Python 风格规范）
...
- **代码示例**：能跑吗？边界情况处理了吗？注释和代码一致吗？是否符合 Python 最佳实践（PEP 8）？
- **Python 特性**：有没有混用 Python 2/3 语法？有没有使用不推荐的写法？
...
- **PyHelper 进度**：是否有 `## PyHelper 进度` 小节？是否在上一周基础上合理演进？
...
| 级别 | 含义 | 示例 |
|------|------|------|
| **S1 致命** | 概念错误、代码跑不通、答案错误 | 语法错误、逻辑错误、solution.py 答案错 |
| **S2 重要** | 可能误导学生、缺失关键信息 | 概念表述不严谨、缺少边界情况说明、违背 Python 最佳实践 |
...
## 教学法建议
[3-5 条可执行的建议，关注目标对齐、递进优化、示例-练习对应、PyHelper 演进]
