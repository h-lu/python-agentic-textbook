...
export default async function Week01Page() {
  const contentPath = path.join(process.cwd(), 'public', 'chapters', 'week-01.md')
  ...
  const currentIndex = data.chapters.findIndex((c: any) => c.week === '01')
    ...
    <div className="min-h-screen bg-white">
      <header className="bg-slate-900 text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">Week 01：从零开始，你的第一行 Python 代码</h1>
        </div>
      </header>
