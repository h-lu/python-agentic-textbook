try:
    ...
    from .records import add_record, list_records, stats
...
def demo() -> str:
    ...
    add_record(records, "2026-05-13", "完成模块化拆分")
    return "\n".join([build_welcome("同学"), advice_for_mood("卡住"), *list_records(records), stats(records)])
