...
if __name__ == "__main__":
    ...
    # 测试添加记录
    add_record(records, {"date": "2026-02-09", "content": "学了 JSON", "mood": "开心"})
    add_record(records, {"date": "2026-02-08", "content": "学了导入导出", "mood": "困惑"})
    ...
    # 测试覆盖已有记录
    add_record(records, {"date": "2026-02-09", "content": "复习 JSON", "mood": "自信"})
