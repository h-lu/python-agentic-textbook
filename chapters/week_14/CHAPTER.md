...
AI 编程工具的普及让"写代码"的门槛大幅降低，但"发布一个完整的软件"仍然是稀缺技能。很多未完成的项目死于"最后 10%"：缺少 README、没有测试、文档不完整、不会做版本发布。这些都不是"写代码"的问题，而是"工程素养"的问题。
...
>
> AI 工具在"项目结构生成"方面的能力正在提升。你描述"一个命令行学习助手"，AI 不只生成函数，还可能生成完整的目录结构、测试框架、配置文件。但问题也随之而来：AI 生成的结构往往**过度工程化**——太多类、太多抽象层、太复杂的设计模式，远超实际需求。
>
...
>
> 学完 Python 基础之后做什么？AI 编程工具的普及让"写代码"的门槛降低，但"成为优秀的开发者"需要更系统的成长路径。结合开发者社区常见路线和 Python 生态实践，学完基础后有几条常见路径：
>
> **路径 1：Web 开发**（最常见）
