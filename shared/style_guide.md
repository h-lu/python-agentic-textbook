...
- **必须基于真实数据**：agent 写此段落时应使用 Context7 MCP 或 WebSearch 查证事实，不编造

示例（Week 01 风格参考）：

> 2025 年，GitHub Copilot 的月活用户突破 180 万，AI 一天能生成的代码量超过许多程序员一年的产出。有人说"学编程已经没用了"——但事实恰恰相反。就像自动驾驶时代你仍然需要理解交通规则，AI 写代码的时代，读懂代码反而更重要了。本周，你将写下人生中的第一行 Python 代码。这不只是一句 `print("Hello")`，而是你和计算机之间对话的起点。
